...
class KDTree
{
  ...
  private:
     ...
     */
     int partition(vector<Point<Dim>> & list, int left, int right, int pivot, int dimension);
     ...
     */
     Point<Dim> getMedian(vector<Point<Dim>> & list, int left, int right, int medianIndex, int dimension);
     ...
     * @param dimension The current dimension.
     */
     void makeNode(KDTreeNode *& subroot, vector<Point<Dim>> & list, int left, int right, int dimension);
     ...
     * @param right The right boundary.
     * @param dimension The current dimension.
     * @return The nearest neighbor of target point query.message
     */
     Point<Dim> neighborFinder(const Point<Dim>& query, int left, int right, int dimension) const;
};
